fun main() {
    ...
    // 1. Laufvariable erstellen: heißt meistens einfach "i", das steht für Iterator
...
/* Fertig ist die Schleife! Noch eine Verständnisfrage:
    ...
    --> Weil der Listenindex bei 0 anfängt, ich schätze mal andersrum wird eine ArrayIndexOutOfBoundException hervorgerufen
